...
def launch(experiment_name='BGN_diabete',
           ...
           max_hdlr=[1],
           max_repl=[100],
           max_coef_per_neur=[2],  # Put to 0 to have standard linear regression
    ...
    """
        ...
        Args:
            ...
            n_folds (): Number of n_folds. 0 for standard k for k-CV
            ...
            for fold_num in range(max(task_dict['n_folds'], 1)):
                ...
                if (cnt_nw == 0):
                    ...
                    file.write('BGN' + '\t' + task_dict['dataset_name'] + '\t' + str(task_dict['seed']) +
                               ...
                               '\t' + str(task_dict['max_repl']) + '\t' + str(
                               task_dict['max_coef_per_neur']) + "\t" + str(task_dict['initial_C']) + "\t" +

...
A Python 3.11.2 implementation of the Binary Greedy Network (BGN) algorithm from the article *Seeking Interpretability and Explainability in Binary Activated Neural Networks*.
